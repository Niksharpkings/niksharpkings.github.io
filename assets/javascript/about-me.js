  ...
  content: `
    <details class="resume-details">
      ...
      <p class="about-me-inner">
        <br>
        This website is from scratch using vanilla HTML5, CSS3, and JavaScript. In the future, I plan to integrate more JavaScript, TypeScript, Node.js, and other technologies.
        <br><br>
        ...
        <br><br>
        I am dedicated, determinant, committed with diligence, self-motivated, composed at discretion, and passionate about learning and problem-solving. I enjoy both team collaboration and independent work, aiming to improve my coding skills and develop innovative solutions.
        <br><br>
        My goal is to enhance my technological skills through software development courses and learning about the coding developments platforms as Microsoft Windows, Azure, AWS, Heroku, and Google Cloud services.
        <br><br>
  ...
  resume: [
    {
      ...
      details: `
        <p class="details-p">
          <br>
          • Regulated, setup, enforced, managed public events/block-party/festivals
          <br>
          ...
          <br>
          • Business-to-Business collaborate crime prevention and deterioration.
          <br>
          • Worked with Law Enforcement to detain or escort criminals and mischief-maker out of the premises of the town.
          <br>
          • Assisted street cleaning crew with removal of trash, graffiti, property damage, sanitation, and other malicious or hazard material or obstruction.
          <br>
          • Effectively communicated pertinent information to employees, visitors, guests, store managers and staff, locals, and tourists.
          <br>
          • Enforced and stopping vagrant panhandling, tent curfew, & breaking up fights.
        </p>
      `
    },
    {
      ...
      details: `
        <p class="details-p">
          ...
          <br>
          • Promoted after two months from a standard guard to private Rover Officer for the Vice President of the Burbank's Division.
          <br>
    ...
    },
    {
      ...
      details: `
        <p class="details-p">
          ...
          <br>
          •Provided assistance to other security during day watch for apprehensive assistance.
          <br>
          • CCTV controls in assistance in catching internal & external suspects.
        </p>
      `
    },
    {
      ...
      details: `
        <p class="details-p">
          ...
          <br>
          • Diminished over a million dollars in online fraud transactions in one year's work, though meticulously reviewed and revised red flagged orders.
          <br>
          ...
          <br>
          • Locate retail employee fraud and theft. and locating retail employee fraud and theft.
        </p>
      `
    },
    {
      ...
      details: `
        <p class="details-p">
          <br>
          • Web Browser-cross platform testing, W3C Compliance testing, and web posting.
          <br>
    ...
    },
    {
      ...
      details: `
        <p class="details-p">
          Languages:
          <br>
          | <abbr title="Hyper Text Markup Language">HTML</abbr>5 & XHTML | <abbr title="cascade style sheet">CSS</abbr>3 | JavaScript | REST | APIs | JSON | XML | AJAX | Typescript | NodeJs | ReactJs | Angular | Redux | C | C# | C++ | Dotnet | Java | SQL | MySQL | GraphQL | Apollo | Mongodb | YML | Go | PHP | GIT | XML | Python | PowerShell | Bash | English |
          <br><br>
          Software/Programs/Apps:
          <br>
          | NodeJs | NPM | GitHub | CMS environments e.g. Shopify | RetailPro | Applications-Savvy | Visual Studio & Code | JetBrains | Android Studios | Blender | Adobe Creative Cloud | Microsoft Full 365 Apps | Employees Auditing and Data Analysis | SAP Business Objects | Retail KPI's and Data Formulations |
          <br><br>
          Cloud:
          <br>

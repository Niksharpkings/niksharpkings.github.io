...
const projectsData = [
  ...
  {
    title: "M6: Git-it-done",
    liveLink: "https://www.niksharpkings.com/git-it-done/",
    repoLink: "https://github.com/Niksharpkings/git-it-done",
    description: "Get-it-done: Module 6 UCLA project: Vanilla HTML5, CSS3, Javascript, Json, Github, Github Pages, ReadMe.md, .txt, Git-Bash. . A GitHub repository search engine that allows users to search for GitHub repositories by keyword. The application uses the GitHub API to fetch repository data based on the user's search query and displays the results in a user-friendly format. By Revamp I mean I redid the entire project from scratch after graduation.",
...
function generateProjects() {
  ...
  projectsData.forEach(project => {
    ...
    const webpSrc = project.imageSrc.replace(/\.(png|jpe?g)$/i, '.webp');
    ...
    img.addEventListener('error', () => {
      // If the selected WebP source fails, remove it and retry the original image.
